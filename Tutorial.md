...
* ##### Подтвердите email
* ##### Пришлите в вк, или в конфу вк никнейм, указанный при регистрации - я дам вам доступ к репозиторию
---
...
*Файлы для git можно хранить в любой папке на компьютере - но куда удобнее будет создать отдельную папку, назвав ее к примеру git, и хранить там все скачанные репозитории, с которыми вы ведете работу*  
