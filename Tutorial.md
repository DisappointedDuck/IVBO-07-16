...
**Она буит вот тута**, и удаленная ветка будет закреплена за вашей локальной. Если вы не уверены, на правильную ли ветку вы заливаете изменения, воспользуйтесь **git remote -v** - она выведет все доступные удаленные ветки*
...
21. Замените текст в списке по шаблону, указанному в этом файле. В скобки вставьте ссылку из пункта 16
